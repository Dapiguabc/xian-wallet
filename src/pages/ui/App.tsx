    ...
    <Box h="100%">
      <Flex
        ...
        <Flex align="center" gap="10px">
            <Select onChange={(e) => networkStorage.changeNetwork(e.target.value)} size='sm' variant='unstyled' width='auto' defaultValue={currentNetwork.name}>
                {
                    networkList.map(t => <option key={t.chainId} value={t.chainId}>{t.chainId}</option>)
                }
            </Select>
