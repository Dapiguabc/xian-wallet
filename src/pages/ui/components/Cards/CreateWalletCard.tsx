  ...
  return (
    <Card {...cardStyle}>
      ...
      <CardBody p={0} mb="10px" lineHeight={1.5}>
        ...
        to remember it, as it <Text as="span" fontWeight={700}>cannot be recovered</Text>. After creating a wallet, remember to export your private key in the
        settings for backup.
      ...
      <CardFooter width="100%" p={0}>
        <Stack flexGrow={1}>
          <Button colorScheme="red" disabled={errMsg !== ''} onClick={ () => confirm(passwordValue) }>Create Wallet</Button>
