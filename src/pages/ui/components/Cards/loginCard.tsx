import { Button, Card, CardBody, CardFooter, CardHeader, Heading, Stack, Text, Input, Box, Alert, AlertIcon, AlertTitle} from '@chakra-ui/react';
  ...
  return (
    <Card {...cardStyle}>
      ...
      <CardFooter width="100%" p={0}>
        <Stack flexGrow={1}>
          <Button colorScheme="red" onClick={unlock}>Unlock Wallet</Button>
          <Button colorScheme="blue" onClick={remove}>Remove Wallet</Button>
        </Stack>
      </CardFooter>
    </Card>
  );
