import { Box, Text, Button, Card, CardBody, CardFooter, CardHeader, Heading, Input, Stack, useToast } from '@chakra-ui/react';
  ...
  return (
    <Card {...cardStyle}>
      ...
      <CardFooter width="100%">
        <Stack flexGrow={1}>
          <Button colorScheme="red" onClick={run} isLoading={loading}>Add Token</Button>
