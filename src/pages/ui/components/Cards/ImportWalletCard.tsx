import { Alert, AlertIcon, AlertTitle, Box, Button, Card, CardBody, CardFooter, CardHeader, Heading, Input, Stack, Text } from '@chakra-ui/react';
...
const ImportWalletCard: React.FC<Props> = ({ next, back }) => {
  ...
  return (
    <Card {...cardStyle}>
      ...
      To import a wallet, please enter your private key and a password. This password will be used to encrypt your private key. Make sure to remember it, as it <Text as="span" fontWeight={700}>cannot be recovered</Text>.
      ...
      <CardFooter width="100%" p={0}>
        <Stack flexGrow={1}>
          <Button colorScheme="red" disabled={errMsg !== ''}  onClick={() => confirm(passwordValue, privateKey) }>Create Wallet</Button>
