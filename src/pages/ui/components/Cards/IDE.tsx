import { Alert, AlertIcon, AlertTitle, Box, Button, Card, CardBody, CardFooter, CardHeader, Heading, Input, Link, Stack, Text, useToast } from '@chakra-ui/react';
...
const IDE: React.FC<Props> = ({ back }) => {
  ...
  return (
    <Card {...cardStyle} maxWidth='705px'>
      ...
      This is the most basic form of the Xian IDE. You can use it to write and deploy smart contracts on the Xian Network. Find standardized smart contract 
      templates <Link color='#007bff' href='https://github.com/xian-network/xian-standard-contracts' isExternal>here</Link> and docs <Link color='#007bff' href='https://github.com/xian-network/smart-contracts-docs' isExternal>here</Link>.
      Deployed Smart Contracts can be directly interacted with by using <Link color='#007bff' href='#'>Advanced Transactions</Link>.
      ...
      <CardFooter width="100%" p={0}>
        <Stack flexGrow={1}>
          <Button colorScheme="red"  onClick={run} isLoading={loading} isDisabled={disable}>Deploye Contract</Button>
